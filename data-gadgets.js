window.DESK_GADGETS = [
  {
    ...
    properties: { "Type": "Macro Pad", "Keys": "15 LCD buttons", "Software": "Stream Deck app (profiles, plugins)" }
  },
  {
    ...
    diyDifficulty: "Moderate (soldering)",
    ...
    properties: { "Type": "DIY Macro Pad", "Keys": "5 keys + 1 rotary encoder", "Firmware": "QMK", "Hot‑Swappable": "Yes" }
  },
  {
    ...
    diyDifficulty: "Advanced (Arduino + 3D printing)",
    ...
    properties: { "Type": "DIY Macro Pad", "Keys": "8–12 keys (customisable)", "Controller": "ESP32 / Arduino Pro Micro", "Software": "DeckMaster / BLE HID" }
  },
  {
    ...
    summary: "A slim, lightweight 1080p portable monitor powered by a single USB‑C cable. Perfect as a secondary screen for laptops, a compact teleprompter display, or a small stat monitor for your gaming rig.",
    properties: { "Type": "Portable Monitor", "Resolution": "1920x1080 IPS", "Size": "15.6\"", "Connectivity": "USB‑C (power+video), mini HDMI" }
  },
  {
    ...
    properties: { "Type": "USB Switch", "Ports": "2‑in, 4‑out USB 3.0", "Button": "Physical switcher" }
  },
  {
    ...
    properties: { "Type": "Soldering Aid", "Arms": "4 magnetic flexible arms", "Base": "Heavy steel with magnetic pads" }
  },
  {
    ...
    properties: { "Type": "Headset Magnifier", "Lenses": "Interchangeable (1.5X–3.5X)", "Light": "LED" }
  },
  {
    ...
    properties: { "Type": "Fume Extractor", "Power": "USB", "Filter": "Activated carbon" }
  },
  {
    ...
    properties: { "Type": "Monitor Riser", "Material": "Bamboo", "Dimensions": "42 cm × 24 cm × 9 cm" }
  },
  {
    ...
    properties: { "Type": "Clamp‑On Power Strip", "Outlets": "3 AC + 2 USB‑A + 1 USB‑C", "USB‑C Power": "20W PD" }
  },
  {
  ...
  },
  {
    ...
    properties: { "Type": "Headphone Hanger", "Mount": "Clamp / Adhesive" }
  },
  {
    id: "felt-desk-mat", category: "gadgets", name: "Felt Desk Mat", brand: "Orbitkey", status: "Wishlist",
    topPickBadge: "Best Premium Desk Mat", price: "$59",
    diyDifficulty: "Plug & Play",
    purchaseUrl: "https://www.orbitkey.com/products/desk-mat",
    ...
    properties: { "Type": "Desk Mat", "Material": "Wool felt", "Features": "Cable rail, document hideaway" }
  },
  {
    ...
    properties: { "Type": "Extended Mouse Pad", "Material": "Micro‑textured cloth", "Lighting": "Edge RGB (Chroma)" }
  },
  {
    id: "cable-tray-under-desk", category: "gadgets", name: "Under‑Desk Cable Management Tray", brand: "Vivo", status: "Wishlist",
    price: "$25",
    diyDifficulty: "Easy (clamp‑on)",
  ...
  },
  {
    ...
    properties: { "Type": "Cable Raceway", "Material": "PVC" }
  },
  {
    ...
    properties: { "Type": "Cable Ties", "Quantity": "50‑pack" }
  },
  {
    id: "kasa-smart-plug", category: "gadgets", name: "KP125M Smart Plug (2‑pack)", brand: "TP‑Link Kasa", status: "Wishlist",
    price: "$19 (2‑pack)",
    diyDifficulty: "Plug & Play",
    ...
    properties: { "Type": "Smart Plug", "Connectivity": "Wi‑Fi 2.4 GHz", "Features": "Voice control, scheduling" }
  },
  {
    ...
    properties: { "Type": "Wrist Rest", "Material": "Wood", "Sizes": "60%, TKL, Full‑Size" }
  },
  {
    ...
    properties: { "Type": "Monitor Light Bar", "Power": "USB", "Colour Temp": "2700K – 6500K" }
  },
  {
    ...
    properties: { "Type": "Chair Mat", "Material": "Polycarbonate" }
  },
  {
    ...
    properties: { "Type": "Macro Pad", "Keys": "32 LCD buttons" }
  },
  {
    id: "programmable-foot-pedal", category: "gadgets", name: "USB Programmable Foot Pedal", brand: "iKKEGOL", status: "Wishlist",
    topPickBadge: "Excellent Ergonomic Shortcut for Modders", price: "$29",
    diyDifficulty: "Plug & Play (software configuration)",
    tags: ["Foot Pedal", "Ergonomic", "Shortcut", "Soldering"],
    summary: "A triple foot pedal that can be programmed to any key or macro. Use it for push‑to‑talk, solder iron control, or a third mouse button while both hands are busy. Incredibly useful for modding and streaming.",
    properties: { "Type": "Foot Pedal", "Pedals": "3 programmable", "Software": "Custom HID mapping" }
  },
  {
    id: "diy-custom-cable-kit", category: "gadgets", name: "DIY Custom Keyboard Cable Kit", brand: "Zap Cables", status: "Wishlist",
    topPickBadge: "Make Your Own Coiled Aviator Cable", price: "$35 (kit)",
    diyDifficulty: "Moderate (soldering, heat‑shrink)",
    purchaseUrl: "https://zapcables.com/diy-cable-kit/",
    tags: ["DIY", "Cable", "Keyboard", "Aesthetics"],
    summary: "Everything you need to build a custom coiled USB cable with an aviator connector. Choose your paracord colour, techflex, and connector. A fun modding project that makes your setup look unique.",
    properties: { "Type": "DIY Cable Kit", "Length": "~2m total", "Includes": "Paracord, techflex, aviator connector, USB ends" }
  }
];
