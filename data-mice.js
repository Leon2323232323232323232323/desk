window.DESK_MICE = [
  ...
  },
  {
    ...
    repairability: { score: "10 / 10 (Zero Risk / Toolless Hot-Swap)", screwCount: "0 Screws (Magnetic Top Cover & Button Shell)", fragilePoints: ["None (Push-Fit Switch Sockets II require ZERO soldering)"], recommendedIronTemp: "NO SOLDERING REQUIRED (Toolless Switch Puller)" },
    ...
    glidesAndPad: { stockSkates: "100% PTFE Rounded-Edge Feet", recommendedSkates: "Stock ROG 100% PTFE Glides", recommendedPadType: "Hard Plastic or Hybrid Speed Pad" },
    lifespanEstimates: {
    ...
    cons: ["Premium price tag ($139 - $159)", "Relatively heavy at 123g"],
    setupNotes: [
  ...
  },
  {
    ...
    repairability: { score: "5.0 / 10 (Optical Switches SMT)", screwCount: "18 Screws (Phillips #0)", fragilePoints: ["Main M1/M2 switches are surface-mounted LIGHTFORCE opto-hybrid units (Cannot be desoldered)"], recommendedIronTemp: "Do not attempt soldering main M1/M2 clicks" },
    ...
    glidesAndPad: { stockSkates: "Large White PTFE Glides", recommendedSkates: "Tiger Ice v2 G502 X Skates", recommendedPadType: "Cloth Pad / Desk Mat" },
    lifespanEstimates: {
